...
- git_master_make_scenarios.R sets the remaining simulation settings and creates master_scenarios_complex.csv
...
- git_master_act_functions is the source script, a lot of overlap with git_master_functions.R but adjusted to dataset
- git_master_actigraph contains the traditional metrics, sensitivity analysis, fitting of Markov models on entire dataset, plots
- git_leave_one_out_classification.Rmd contains the leave-one-out cross-validation on the DEPRSJON dataset
